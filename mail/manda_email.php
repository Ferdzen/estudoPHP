...
*/
	...
	$mail->FromName = "Sistema SI 2022"; // Seu nome

	// Define os destinatário(s)
	// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
	$mail->AddAddress("felipezubko@gmail.com", "felipe zubko");
	$mail->AddAddress("felipezubko@gmail.com");
	...
	// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
	$mail->Subject = "PRÊMIO ESPECIAL"; // Assunto da mensagem
	$mail->Body = "<p>Olá tudo bem? Você foi premiado com uma viagem para Grécia </p>
    <p>Para que você possa receber o prêmio clique no link abaixo</p>
    <h1>Não perca essa oportunidade o link expira em 60 minutos</h1>";
