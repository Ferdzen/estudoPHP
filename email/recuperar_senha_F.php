...
if( mysqli_num_rows($cst_recuperacao) == 1 ){
	...
	$link="https://ig10.com.br/solidariza/recuperar_page.php?uid=$uid&pass=$pass&usuario=${usuario}&confirmacao=$chave";
			//echo "$link";
	...
	$mail->FromName = "SuporteSystem"; // Seu nome

	// Define os destinatário(s)
	// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
	$mail->AddAddress("$usuario", "$usuario_nome");
	...
	$xpto="Existe uma solicitação de recuperação de senha para seu usuário no sistema <b>PEOPLE SYSTEM</b>. </br> </br>
	Data: $validade </br>
	Hora: $agora </br>
	IP: $IP </br> </br>
